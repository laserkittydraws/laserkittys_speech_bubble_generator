...
class RoundBubble(SpeechBubble):
    ...
    def getPreview() -> str:
        if RoundBubble._tailLength > 0 and RoundBubble._tailWidth > 0:
            ...
            return f'M {tailPointX0} {tailPointY0} A {RoundBubble._width/2} {RoundBubble._height/2} \
            ...
            RoundBubble._logger.log(LSBG_DEBUG_VERBOSE, f'tail disabled, \
                ellipse points: ({ellipsePX-RoundBubble._width}, {ellipsePY}) ({ellipsePX}, {ellipsePY})')

            return f'M {ellipsePX} {ellipsePY} \
                A {RoundBubble._width/2} {RoundBubble._height/2} 0 1 0 {ellipsePX-RoundBubble._width} {ellipsePY} \
                A {RoundBubble._width/2} {RoundBubble._height/2} 0 1 0 {ellipsePX} {ellipsePY} Z'